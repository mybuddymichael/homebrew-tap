...
class Mint < Formula
  ...
  url "https://github.com/mybuddymichael/mint/archive/v0.1.0.tar.gz"
  sha256 "948a622ebcf2b80e7081f117eb0745d43961d6572f4c30b0f272b0c4af6fe9a3"
  ...
  def install
    system "go", "build", "-trimpath", *std_go_args(output: bin/"mint", ldflags: "-s -w -X main.version=v0.1.0"), "."
  end
