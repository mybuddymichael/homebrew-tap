...
class Cast < Formula
  ...
  url "https://github.com/mybuddymichael/cast/archive/v0.3.1.tar.gz"
  sha256 "de6ea13d6b386df80d3e3629315651c96a9fb64617f2bfa6a1081aabe145549a"
  version "v0.3.1".delete_prefix("v")
  license "MIT"
