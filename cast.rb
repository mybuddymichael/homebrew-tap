...
class Cast < Formula
  ...
  url "https://github.com/mybuddymichael/cast/archive/v0.3.2.tar.gz"
  sha256 "6abd786c96eed6bec21efbb5fa02264dc3a398f35579d7bd9e565cdacdee712e"
  version "v0.3.2".delete_prefix("v")
  license "MIT"
